...
class PLD_dropdown(QWidget):
    def __init__(self):
        ...
        self.pageCombo.addItems(["Target_1", "Target_2", "Target_3", "Target_4", "Target_5", "Target_6"]) 
    ...
    def get_info(self):
        ...
        for i in range(6):
            info_dict['target_'+str(i+1)] = {
                        ...
                        "Focus": self.focus_input[i].text(),
                        "Attenuator": self.attenuator_input[i].text(),
                        "Target Height": self.target_height_input[i].text(),           

                        "Laser Voltage": self.laser_voltage_input[i].text(),
                        "Laser Energy": self.laser_energy_input[i].text(),
                        "Measured Energy": self.measured_energy_input[i].text(),

                        "Temperature": self.pre_temperature_input[i].text(),
                        "Pressure": self.pre_pressure_input[i].text(),
                        "Gas Atmosphere": self.pre_gas_input[i].text(),
                        "Frequency": self.pre_frequency_input[i].text(),
                        "Pulses": self.pre_number_pulses_input[i].text(),           

                        "Temperature": self.temperature_input[i].text(),
                        "Pressure": self.pressure_input[i].text(),
                        "Gas Atmosphere": self.gas_input[i].text(),
                        "Frequency": self.frequency_input[i].text(),
